...
import edu.fudan.sa.circle.jade.invocation.JadeServiceListener;
import edu.fudan.sa.circle.jade.publication.JadeServicePublisher;
import edu.fudan.sa.circle.jade.resolution.JadeServiceResolver;
 ...
 */
public class JadeCircle extends SocialCircle implements HeartBeatService.HeartBeatListener {

	protected AID serviceRegistryId;
	private Me owner;
	private JadeServiceResolver resolver;
	private JadeServicePublisher publisher;
	private JadeServiceListener listener;

	public JadeCircle(CircleDriver circleDriver, AID memberRegistryId) {
	...
	private void init(Me me) {
		...
		this.resolver = new JadeServiceResolver(this);
		this.publisher = new JadeServicePublisher(this.owner, this);
		this.listener = new JadeServiceListener();
	}
