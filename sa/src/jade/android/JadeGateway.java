...
public class JadeGateway {
    ...
    public final static void connect(String agentClassName, String[] agentArgs, Properties jadeProfile, Context ctn, ConnectionListener list) throws Exception {
        ...
        Intent i = new Intent(ctn, JadeMicroRuntimeService.class);
     ...
     *
     * @throws jade.wrapper.StaleProxyException if the method was not able to execute the Command
     * @throws jade.wrapper.ControllerException if agent is not reachable
